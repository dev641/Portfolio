...
const portfolioCard: render = ({ heading, likeBtn: { number, name: { logoClass } }, image: { name: imageName, src }, skillSet }: PortfolioCard) => {
  return `
    <div class="portfolio-card card dark-card" id="portfolio-card">
          ...
          <div class="portfolio-card__main-skill" id="portfolio-card__main-skill">${skillSet[0].name}</div>
