...
const portfolioCard: render = ({ heading, likeBtn: { number, name: { logoClass } }, image: { name: imageName, src }, skillSet }: PortfolioCard, ind: number) => {
  return `
    <div class="portfolio-card card dark-card" id="portfolio-card" tabindex="${ind}">
